...
Or programmatically::
    ...
    from lynx_compare.interfaces.server import create_app
    app = create_app()
    app.run(port=8080)
"""
...
from lynx_compare.core.about import (
    APP_NAME,
    DEVELOPER,
    DEVELOPER_EMAIL,
    LICENSE_NAME,
...
def create_app(run_mode: str = "production"):
    ...
    def export_endpoint():
        ...
        try:
            from lynx_compare.api import compare_companies
            from lynx_compare.render.export import export_html, export_text, export_pdf
    ...
    def compare_many_endpoint():
        ...
        try:
            from lynx_compare.core.multi import compare_many
            result = compare_many(
                *validated,
                refresh=refresh,
                download_reports=download_reports,
