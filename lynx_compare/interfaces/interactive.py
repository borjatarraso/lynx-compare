...
def run_interactive(args) -> None:
    ...
    from lynx_compare.interfaces.cli import _run_analysis, AnalysisTimeoutError
    ...
    while True:
        try:
            ...
            # Easter egg check
            from lynx_compare.core.about import check_easter_egg
            ...
            from lynx_compare.core.engine import compare
            from lynx_compare.render.display import display_comparison
...
def _show_about() -> None:
    ...
    from lynx_compare.core.about import about_text
    console.print()
    console.print(Panel(
        about_text(),
...
def _show_easter_egg() -> None:
    ...
    from rich.panel import Panel
    from lynx_compare.core.about import easter_egg_text
    console.print()
    console.print(Panel(
...
def _handle_export_cmd(cmd: str, last_result) -> None:
    ...
    import os
    from lynx_compare.render.export import export_comparison, default_export_path
    ...
    if not arg:
        ...
        from lynx_compare.render.export import _default_export_dir
        console.print()
